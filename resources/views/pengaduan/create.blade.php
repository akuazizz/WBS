...
<head>
    ...
    <style>
        ...
        /* ---------- Form Controls ---------- */
        /* NOTA: input[type=file] sengaja di‑HAPUS dari aturan ini */
        .form-input-custom,
        input[type="text"],
        input[type="email"],
        select,
        ...
        /* hilangkan background + border agar tidak ada “kotak teks” */
        input[type="file"] {
            background-color: transparent;
            border: none;
            padding: 0;
            height: auto;
            width: auto;   /* biar panjangnya mengikuti konten */
            box-shadow: none;
        }
    </style>
...
<body class="antialiased" x-data="{ showModal: true }" x-init="$nextTick(() => showModal = true)">
    ...
    <header class="py-4 bg-white shadow-sm">
        <div class="container mx-auto px-6 flex justify-between items-center">
            <a href="#"><img src="https://wbs.bappenas.go.id/img/logo_wbs4.png" alt="Logo WBS Banjarnegara" 
            class="h-8"></a>
    ...
    <main class="py-10">
        <div class="container mx-auto px-6 max-w-4xl">
            ...
            <form action="#" method="POST" enctype="multipart/form-data"
                ...
                <!-- KODE PENGADUAN -->
                <div>
                    <label for="kode_pengaduan" class="block text-sm font-medium text-gray-700 mb-1">Kode Pengaduan</label>
                ...
                <!-- JABATAN TERDUGA -->
                <div>
                    <label for="jabatan_terduga" class="block text-sm font-medium text-gray-700 mb-1">Jabatan Terduga</label>
                ...
                <!-- URAIAN PENGADUAN -->
                <div>
                    <label for="uraian_pengaduan" class="block text-sm font-medium text-gray-700 mb-1">Uraian Pengaduan</label>
                ...
                <div>
                    ...
                    <div class="mt-2 flex items-center gap-6">
                        <label class="inline-flex items-center">
                            <input type="radio" name="info_pelapor" value="bappenas" checked
                                   class="form-radio h-4 w-4">
                            <span class="ml-2 text-gray-700">ASN</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="info_pelapor" value="non-bappenas"
                                   class="form-radio h-4 w-4">
            ...
            <div class="p-8">
                <div class="text-center mb-6">
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Data pelapor pada Whistleblowing System dilindungi oleh UU No. 27 Tahun 2022 tentang Perlindungan
                        Data Pribadi.
                    </p>
                </div>
                <div class="bg-red-50 p-4 rounded-lg text-sm text-red-800">
                    <p class="font-bold">
                        Kementerian PPN/Bappenas akan merahasiakan identitas pribadi Anda, perhatikan hal-hal berikut:
                    </p>
