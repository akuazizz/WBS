        ...
        <main class="py-10">
            <div class="container mx-auto px-6 max-w-4xl">
                <div class="text-center text-white mb-8">
                    ...
                    <p class="mt-2 text-lg">Memudahkan pengguna memantau status terkini, riwayat, dan perkembangan
                        pengaduan yang telah diajukan.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <form action="#" method="POST">
                        <input type="text" name="kode_pengaduan"
                            placeholder="Masukkan kode pengaduan untuk mengetahui status tracking pengaduan Anda."
