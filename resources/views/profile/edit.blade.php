...
@section('content')
    ...
    <div x-data="{
        ...
        {{-- Saya memindahkan class space-y-8 ke sini agar lebih rapi --}}
        ...
        <div class="bg-[#005a9e] rounded-lg shadow-lg p-8 flex flex-col items-center text-white">
            <div class="w-32 h-32 rounded-full bg-white/30 flex items-center justify-center border-4 border-white">
                {{-- Ganti dengan logic foto profil Anda --}}
            ...
            <a href="#" class="mt-4 font-semibold hover:underline">Edit Foto Profil</a>
        </div>

        {{-- Card Data Akun (Tampilan Read-Only) --}}
        <div class="bg-white rounded-lg shadow-md">
            <div class="p-4 border-b flex justify-between items-center bg-gray-100 rounded-t-lg">
                ...
                <button @click="showAkunModal = true" class="text-gray-500 hover:text-blue-600 transition"
        ...
        {{-- Card Data Pribadi (Tampilan Read-Only) --}}
        <div class="bg-white rounded-lg shadow-md">
            <div class="p-4 border-b flex justify-between items-center bg-gray-100 rounded-t-lg">
                <h3 class="font-bold text-lg text-gray-700 flex items-center">
                    <svg class="w-6 h-6 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button @click="showPribadiModal = true" class="text-gray-500 hover:text-blue-600 transition"
            ...
            <div class="p-6 space-y-4 text-gray-600">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="col-span-2">: <span
                            class="bg-green-200 text-green-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded">{{ $user->status_user ?? 'Aktif' }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center pt-4">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit"
                    class="bg-blue-800 hover:bg-blue-900 text-white font-bold py-2 px-8 rounded-md transition duration-300">
                    Logout
                </button>
            </form>
        </div>
        ...
        <!-- Form dan Modal Edit Data (digabung agar bisa disubmit bersamaan) -->
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex justify-end pt-4">
                            <button type="submit" form="profile-update-form"
                                class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-md transition">Simpan</button>
                        </div>
                    </div>
                </div>
            </div>
