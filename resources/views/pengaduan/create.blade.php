    ...
    <main class="py-10">
        <div class="container mx-auto px-6 max-w-4xl">
            <div class="text-center text-bappenas-title mb-8">
                ...
                <p class="mt-2 text-lg">Mari bersama-sama menciptakan pemerintahan yang jujur dan bersih, laporkan
                    setiap pelanggaran yang terjadi di lingkungan kerja Anda.</p>
            </div>
            ...
            <form action="#" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Kode pengaduan dibuat secara otomatis oleh sistem dan tidak
                        bisa diubah.</p>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="jabatan_terduga" id="jabatan_terduga"
                        class="form-input-custom block w-full rounded-md shadow-sm sm:text-sm">
                    <p class="mt-1 text-xs text-gray-500">Jika anda tidak tahu jabatannya maka isi lain-lain.</p>
                </div>
                ...
                <div>
                    ...
                    <input type="file" name="dokumen" id="dokumen"
                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-sky-100 file:text-sky-700 hover:file:bg-sky-200">
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2 flex items-center gap-6">
                        <label class="inline-flex items-center">
                            ...
                            <span class="ml-2 text-gray-700">Bappenas</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="info_pelapor" value="non-bappenas" class="form-radio h-4 w-4">
                            <span class="ml-2 text-gray-700">Non-Bappenas</span>
                        </label>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" required
                        class="form-input-custom block w-full rounded-md shadow-sm sm:text-sm">
                    <p class="mt-1 text-xs text-gray-500">Masukkan alamat email yang valid untuk komunikasi lebih
                        lanjut.</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-2xl max-w-2xl w-full" @click.away="showModal = false">
            ...
            <div class="p-8">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800 mt-4">Data Pelapor Terjamin Karena Dilindungi
                        Undang-Undang</h2>
                    <p class="text-sm text-gray-500 mt-1">Data pelapor pada Whistleblowing System dilindungi oleh UU No.
                        27 Tahun 2022 tentang Perlindungan Data Pribadi.</p>
                </div>
                <div class="bg-red-50 p-4 rounded-lg text-sm text-red-800">
                    <p class="font-bold">Kementerian PPN/Bappenas akan merahasiakan identitas pribadi Anda, perhatikan
                        hal-hal berikut:</p>
