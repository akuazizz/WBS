...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\xampp baru\htdocs\WBS\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\xampp baru\\htdocs\\WBS\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'home','profile.edit','profile.update','profile.destroy',
'pengaduan.create','pengaduan.store','tracking.index','tracking.search','dashboard',
'profile.update.akun','profile.update.pribadi','pengaduan.saya','pengaduan.show','pengaduan.tindaklanjut.store',
'admin.dashboard','admin.pengaduan.index','admin.pengaduan.show','admin.pengaduan.tanggapan.store','register','login','password.request','password.email',
...
'admin.dashboard','admin.layouts.admin','admin.pengaduan.index','auth.confirm-password','auth.forgot-password',
...
'components.secondary-button','components.text-input','dashboard','dashboard.home','emails.custom_reset_password',
'emails.pengaduan-diterima','layouts.app','layouts.guest','layouts.navigation','partials.update-profile-information-form',
'pengaduan.create','pengaduan.index','pengaduan.show','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','tracking.index','welcome','laravel-exceptions-renderer::components.card',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','id.0',
