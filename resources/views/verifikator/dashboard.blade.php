...
@section('content')
  <div class="bg-white rounded-lg shadow-md p-6 md:p-8">
    ...
    <table class="min-w-full bg-white border border-gray-200">
      ...
      <span
        class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">Baru</span>
      ...
      <span
        class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Selesai</span>
      @else
      <span
      ...
      @endif
        ...
        class="text-white bg-[#005a9e] hover:bg-[#004b85] ...">
        Verifikasi
        </a>
        </td>
      </tr>
